...
from .bot_get import (convert_to_user_id, get_archived_medias, get_comment,
                      ...
                      get_media_commenters, get_media_commenters_details, get_media_comments,
                      ...
                      get_user_followers, get_user_followers_details, get_user_following, get_user_following_details,
...
class Bot(object):
    ...
    def following(self):
        ...
        if self._following is None or now - last > 7200:
            self.console_print('`bot.following` is empty, will download.', 'green')
            self._following = self.get_user_following_details(self.user_id)
            self.last['updated_following'] = now
        return self._following
    ...
    def followers(self):
        ...
        if self._followers is None or now - last > 7200:
            self.console_print('`bot.followers` is empty, will download.', 'green')
            self._followers = self.get_user_followers_details(self.user_id)
            self.last['updated_followers'] = now
        return self._followers
    ...
    def get_user_followers_details(self, user_id, nfollows=None):
        return get_user_followers_details(self, user_id, nfollows)

    def get_user_following(self, user_id, nfollows=None):
        return get_user_following(self, user_id, nfollows)

    def get_user_following_details(self, user_id, nfollows=None):
        return get_user_following_details(self, user_id, nfollows)
    ...
    def get_media_commenters_details(self, media_id):
        return get_media_commenters_details(self, media_id)
